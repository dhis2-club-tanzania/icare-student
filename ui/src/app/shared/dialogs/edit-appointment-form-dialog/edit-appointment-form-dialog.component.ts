...
export class EditAppointmentFormDialogComponent implements OnInit {
	...
	constructor(
		private dialogRef: MatDialogRef<EditAppointmentFormDialogComponent>,
	...
	ngOnInit(): void {
		...
		this.statusOptions = ["Scheduled", "Missed", "Completed", "Cancelled"];
	}
	...
	async onUpdate(event) {
		...
		await this.api.appointmentscheduling.updateAppointment(appointmentUuid, {
			status,
		});
