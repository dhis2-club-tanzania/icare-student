...
} from "src/app/modules/inpatient/helpers/sanitize-bed-orders.helper";
import { AssignBedToPatientComponent } from "src/app/modules/inpatient/components/assign-bed-to-patient/assign-bed-to-patient.component";
